...
== About this task
You can create a new Microsoft SQL server, or database host, within Workload Factory Databases with AWS account credentials and _automate_ permissions. A new database host requires an FSx for ONTAP file system deployment and resources for Active Directory. 
