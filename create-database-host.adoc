...
== Enable remote connection on the Microsoft SQL server
...
. Ensure that the "Allow remote connections to this server" is enabled in Microsoft SQL Server Management Studio.  
