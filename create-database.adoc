...
.Before you begin
Complete the following prerequisites before you create a new database. 

* *Credentials and permissions*: You must have link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html[AWS account credentials and _operations and remediation_ permissions^] to create a new database in Workload Factory. 
+
