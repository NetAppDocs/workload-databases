...
* *Storage efficiency*
+
Enable storage efficiency features such as compaction, compression, and deduplication on FSx for ONTAP volumes to optimize storage utilization and reduce costs.
