...
For a complete database environment analysis, host instances must be registered and online.

link:register-instance.html[Learn how to register a host instance.]
