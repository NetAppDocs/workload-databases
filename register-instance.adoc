...
+
To have Workload Factory link:optimize-configurations.html[review and fix well-architected issues] for your instances, complete all prerequisites listed under *Review well-architected issues and recommendations* and *Fix well-architected issues* capabilities.
