...
Workload Factory supports registration for Failover Cluster Instance (FCI), Single instance, and Always On availability group (AOAG) deployment models for SQL Server. 
