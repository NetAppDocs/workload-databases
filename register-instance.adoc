...
AWS GovCloud (US) users must use AWS Secrets Manager to authenticate FSx for ONTAP credentials. For all other users, you must authenticate FSx for ONTAP with file system credentials.
