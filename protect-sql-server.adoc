...
== Edit protection for Microsoft SQL Server instances
You can edit protection for Microsoft SQL Server instances that are already protected in NetApp Backup and Recovery. Editing protection allows you to modify the protection policy or schedule for your protected SQL Server instances.
...
. Select *Redirect* to access Backup and Recovery.
