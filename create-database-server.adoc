...
+
Optional: Select to *Use managed service account* for the SQL Server service account. If your environment uses service accounts with password management policies, we recommend using a managed service account.
. Under *Connectivity*, provide the following:
