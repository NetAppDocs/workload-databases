...
==== Resource rollback
If you decide to rollback your DNS resources, the resource records are not removed automatically. You can remove the records from the DNS server as follows.
