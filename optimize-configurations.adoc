...
* Storage layout: includes the following: 
** For SQL Server: user data files placement, log files placement, TempDB placement
** For Oracle: number of LUNs per the following Oracle Automatic Storage Management (ASM) disk groups: data, logs, FRA or +ARCH
