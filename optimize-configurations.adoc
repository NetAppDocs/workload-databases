...
Perform a one-time assessment to find out the well-architected status of your Microsoft SQL Server instances or your Oracle databases without storing credentials or registering resources. 
