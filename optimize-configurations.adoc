...
For SQL Server resources, you can perform a one-time assessment to review best practices for your database configurations. The one-time assessment doesn't require resource registration or credentials.
...
Perform a one-time assessment to determine the well-architected status of your Microsoft SQL Server instances without credentials or instance registration. 
...
. View the recommendation for any configuration. Recommendations include best practices and potential pitfalls of unoptimized configurations.
