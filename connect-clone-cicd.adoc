...
summary: "Connect a sandbox clone to a CI and CD pipeline with REST API code to improve software delivery via automation."
---
= Connect a sandbox clone to CI/CD in NetApp Workload Factory for Databases
:icons: font
:imagesdir: ./media/
