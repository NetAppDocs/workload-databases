...
* Manual mode
+
Now you can customize settings for Microsoft SQL Server, Amazon EC2, and Elastic Block Store settings to explore savings manually. The savings calculator will determine the best file system based on cost.
