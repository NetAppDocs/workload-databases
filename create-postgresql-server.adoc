...
FSx for ONTAP file systems supports _standalone_ deployments for PostgreSQL. Workload factory creates the a Single Availability Zone FSx for ONTAP file system in addition to separate volumes and LUNs for data, log, and tempdb files. 
