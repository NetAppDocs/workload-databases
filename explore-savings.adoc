...
. From Explore savings, select the *SQL Server on Elastic Block Store (EBS)* tab and then select *Analyze custom configuration for Elastic Block Store (EBS)*.
...
. Select the menu image:workloads-menu-icon.png[The hamburger menu icon is used to navigate to workloads like storage, eda, ai, databases, vmware, and administration.] and then select *Databases*.
. From the Databases menu, select *Explore savings*.
. From Explore savings, select the *SQL Server on FSx for Windows* tab and then select *Analyze custom configuration for FSx for Windows File Server*.
. In the Savings calculator, provide the following details: 
.. *Region*: Select a region from the dropdown menu. 
.. *Deployment model*: Select a deployment model from the dropdown menu.
.. *SQL server edition*: Select the SQL server edition from the dropdown menu.
...
. Log in using one of the link:https://docs.netapp.com/us-en/workload-setup-admin/console-experiences.html[console experiences^].
. Select the menu image:workloads-menu-icon.png[The hamburger menu icon is used to navigate to workloads like storage, eda, ai, databases, vmware, and administration.] and then select *Databases*.
. From the Databases menu, select *Explore savings* and then the *SQL Server on Elastic Block Store (EBS)* tab.
...
. Log in using one of the link:https://docs.netapp.com/us-en/workload-setup-admin/console-experiences.html[console experiences^].
. Select the menu image:workloads-menu-icon.png[The hamburger menu icon is used to navigate to workloads like storage, eda, ai, databases, vmware, and administration.] and then select *Databases*.
. From the Databases menu, select *Explore savings* and then the *SQL Server on FSx for Windows* tab.
...
. Log in using one of the link:https://docs.netapp.com/us-en/workload-setup-admin/console-experiences.html[console experiences^].
. Select the menu image:workloads-menu-icon.png[The hamburger menu icon is used to navigate to workloads like storage, eda, ai, databases, vmware, and administration.] and then select *Databases*.
. From the Databases menu, select *Explore savings* and then the *SQL Server on-premises* tab.
. From the SQL Server on-premises tab, do the following: 
