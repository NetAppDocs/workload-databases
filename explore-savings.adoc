...
Workload factory enters the detected Elastic Block Store and FSx for Windows File Server host instance characteristics so that you can explore savings automatically.
