...
Two new features are available to improve the cost savings analysis for running multiple instances with EBS storage so that you can save more by switching to FSx for ONTAP. 
