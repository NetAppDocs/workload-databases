...
BlueXP workload factory for Databases now detects, analyzes, and help you plan for SQL Server on-premises database migration to Amazon FSx for NetApp ONTAP. You can use the savings calculator to estimate the cost of running your SQL Server on-premises database environment in the cloud and review recommendations for migrating your on-premises database environment to the cloud.
