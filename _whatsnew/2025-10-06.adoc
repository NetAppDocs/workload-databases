...
=== Improvements to configuration dismissal for the well-architected analysis

From the well-architected analysis screen, you can select to *Dismiss* any configuration that isn't relevant to your environment. You can also select *Dismissed configurations* to show only dismissed configurations from the list of configuration issues. Remember that you can reactivate a dismissed configuration issue from the list of dismissed configurations at any time.
