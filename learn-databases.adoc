...
* *Simple, fast deployments*: simplify and streamline your provisioning experience by selecting answers to specification questions and eliminating the time typically required to investigate how to provision and configure your Microsoft SQL Server or PostgreSQL instances on AWS.
...
* *Built-in features*: utilize NetApp, Microsoft, Oracle, and Amazon best practices and AWS resource selections built in to deployment configuration.
...
* *Reusable automation templates*: create, re-use, and customize CloudFormation templates from the Workload Factory Codebox for future Microsoft SQL Server and PostgreSQL deployments in multiple environments.
* *AWS resource discovery and provisioning*: automatically detect Microsoft SQL Servers, Oracle databases, and PostgreSQL instances on FSx for ONTAP deployed from your AWS account. The Databases Inventory serves as a launching point for analyzing errors and performance or managing and protecting FSx for ONTAP based servers and instances.
...
* *Continuous optimization*: continuously scan your Microsoft SQL Server and Oracle estates offline for a comprehensive report of insights, opportunities, and recommendations to help you achieve operational excellence.
...
* *LUN association*: view how LUNs are mapped to each Microsoft SQL Server database running on FSx for ONTAP based deployments.
