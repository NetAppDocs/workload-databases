...
For general questions about workload factory or workload factory applications and services, refer to link:get-help.html[Get help for workload factory for Databases].