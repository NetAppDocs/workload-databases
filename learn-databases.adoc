...
* *Simple, fast deployments*: simplify and streamline host, database, and sandbox provisioning with built-in NetApp, Microsoft, and Amazon best practices that eliminate manual configuration complexity for Microsoft SQL Server and PostgreSQL instances on AWS.
...
* *Well-architected assessment feature*: continuously scan your Microsoft SQL Server and Oracle estates for a comprehensive report of insights, opportunities, and recommendations to help you achieve operational excellence, security, reliability, performance efficiency, and cost optimization based on AWS best practices.
