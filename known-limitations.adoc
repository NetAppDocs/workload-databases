...
Workload Factory doesn't support creating or saving configurations for multiple Microsoft SQL Server instances with multiple FSx for ONTAP file systems. Only one FSx for ONTAP file system configuration deployment is supported. 
