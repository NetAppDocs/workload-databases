...
== Host instance detection support
Workload factory supports the detection of PostgreSQL instances running only on the Amazon Linux operating systems and Oracle instances running only on HREL.
