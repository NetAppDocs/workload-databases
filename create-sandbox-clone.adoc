...
* *Credentials and permissions*: You must have link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html[AWS account credentials and _view, planning, and analysis_ permissions^] to create a sandbox clone in Workload Factory.
+
