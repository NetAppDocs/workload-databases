...
If you chose to operate in _read-only_ mode, you can link:discover-resources.html[discover existing resources] to explore savings or view configurations from the inventory.
