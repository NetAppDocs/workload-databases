...
If you chose to operate in _read/write_ mode and you'd like workload factory to manage your resources, you must link:discover-resources.html[discover existing resources] or link:create-database-server.html[deploy a host server].
