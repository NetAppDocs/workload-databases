...
[.lead]
With BlueXP workload factory for Databases, you can get started immediately in _basic_ mode. If you'd like to use workload factory to discover hosts, manage resources, and more, you can get started in a few steps. 
...
Lastly, if you chose to operate in _read/write_ mode, you must link:create-database-server.html[deploy] or link:detect-host.html[register a database server] to manage your host resources and before adding user databases.

.What's next
When you register FSx for ONTAP hosts in your Databases inventory, you can link:create-database.html[create a user database] or link:create-sandbox-clone.html[clone your host to create a sandbox]. 
