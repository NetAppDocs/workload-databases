...
[role="quick-margin-para"]
If you operate in _Basic_ mode, you don't need to go any further. You can start using Workload Factory Databases to copy partially completed code samples. In the Databases tile, click *Deploy database*. link:deploy-host.html[Learn how to deploy a database host]. 
...
Lastly, if you chose to operate in _Automate_ mode, you must link:deploy-host.html[deploy] or link:detect-host.html[detect a database host] to manage your host resources and before adding user databases.
