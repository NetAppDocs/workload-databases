...
Choose the link:https://docs.netapp.com/us-en/workload-setup-admin/permissions-reference.html[permission policies^] to meet your needs. You can opt out of granting permissions and use Workload Factory to generate Infrastructure-as-Code templates for external use.

[role="quick-margin-para"]
If you choose to grant permissions, you'll need to link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html[add credentials to an account manually^] select workload capabilities, such as Databases and GenAI, and create IAM policies for the required permissions.
